...
typedef AllServiceUserCellBlock = Function();

class AllServiceUserCell extends StatelessWidget {

  ServiceUsers serviceUser;
  AllServiceUserCellBlock block;

  AllServiceUserCell({super.key,required this.serviceUser,required this.block});
