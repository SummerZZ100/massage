...
* */
typedef CreateAddressWidgetBlock = Function(int type,String text);
...
class CreateAddressWidget extends StatefulWidget {
  ...
  String contactPhone;
  String sex;
  CreateAddressWidgetBlock block;

  CreateAddressWidget({super.key,required this.address,required this.detailAddress,required this.contactName,
    required this.contactPhone,required this.sex,required this.block});

  @override
  State<CreateAddressWidget> createState() => _CreateAddressWidgetState();

}

class _CreateAddressWidgetState extends State<CreateAddressWidget> {
              ...
              TapContainer(
                childWidget: Container(
                  ...
                  child: Row(
                    children: [
                      Image.asset(
                        "${SystemConfig.resource}contaction_l.png"
                      ),
                      Text(
                        ' 通讯录',
                        style: TextStyle(
