...
typedef SelectServiceUserCellBlock = Function();

class SelectServiceUserCell extends StatelessWidget {

  ServiceUsers serviceUser;
  SelectServiceUserCellBlock block;

  SelectServiceUserCell({super.key,required this.serviceUser,required this.block});
