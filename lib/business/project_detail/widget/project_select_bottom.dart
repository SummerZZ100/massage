...
typedef ProjectDetailBottomBlock = Function();

class ProjectSelectBottom extends StatelessWidget {

  Projects project;
  int number;
  ProjectDetailBottomBlock block;
  ProjectSelectBottom({super.key,required this.project,required this.block,required this.number});
